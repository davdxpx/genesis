      ...
      <AnimatePresence>
        {isSidebarOpen && (
           <motion.aside 
             ...
             className="fixed md:relative left-0 top-0 bottom-0 w-64 flex flex-col border-r border-slate-800/80 bg-[#0A101D]/95 backdrop-blur-xl z-50 shadow-[20px_0_50px_rgba(0,0,0,0.5)]"
           >
